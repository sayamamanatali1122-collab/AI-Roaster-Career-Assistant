...
# ==========================================
# PREMIUM CSS DESIGN SYSTEM WITH ANIMATED DROPDOWNS
# ==========================================
st.markdown("""
<style>
...
/* ── PROFESSIONAL ANIMATED EXPANDER FIX ── */
...
/* Hide broken raw icon text and replace with clean layout */
...
[data-testid="stExpander"] details[open] > div {
    ...
    animation: fadeInSlide 0.3s ease-in-out !important;
}
